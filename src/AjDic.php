...
use Closure;
use Exception;
use AjDic\Contracts\BindingResolutionException;
use AjDic\Contracts\CircularDependencyException;
use AjDic\Contracts\ContainerizeInterface;
use LogicException;
use ReflectionClass;
...
use AjDic\Helper;
use AjDic\BindingBuilder;
use AjDic\AjDicGenerator;
use AjDic\Caller;
use AjDic\EntryNotFoundException;
use AjDic\Traits\HasLoader;

class AjDic implements ArrayAccess, ContainerizeInterface
{
    use HasLoader;
     ...
     * @return \AjDic\Contracts\BindingBuilderInterface
     */
    public function when($concrete)
    {
        ...
        return new BindingBuilder($this, $aliases);
    }
    ...
    /**
     * Bind a callback to resolve with \AjDic\AjDic::call.
     *
    ...
    public function tagged($tag)
    {
        ...
        return new AjDicGenerator(function () use ($tag) {
    ...
    public function call($callback, array $parameters = [], $defaultMethod = null)
    {
        ...
        $parameters = Helper::namedParamatersToArry($callback, $parameters);

        $result = Caller::call($this, $callback, $parameters, $defaultMethod);
     ...
     * @return mixed
     *
     * @throws \AjDic\Contracts\BindingResolutionException
     */
     ...
     *
     * @throws \AjDic\Contracts\BindingResolutionException
     * @throws \AjDic\Contracts\CircularDependencyException
     */
     ...
     *
     * @param  \AjDic\Contracts\ContainerizeInterface|null  $container
     * @return \AjDic\Contracts\ContainerizeInterface|static
     */
    public static function setInstance(ContainerizeInterface $container = null)
    {
